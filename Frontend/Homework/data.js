...
// Array.prototype.findUserById = function(callback){
...
//-Nhập vào 1 chuỗi keyword. Hãy lấy ra email của các user có tên (first_name + last_name) chứa keyword.
// const keyword = String(prompt('Nhập một chuỗi keyword: '));
// let filteredUser = users.filter(user => (user.first_name + user.last_name).includes('keyword'));
// let userByKeyword = filteredUser.map(user => user.email);
...
// 	}
// }
// console.log('Số người hơn 30 tuổi là: ' ,count);

//cách 2
// let countUser = users.filter(user => user.age >30);
// console.log(countUser);

//cách 1
// let countMarried = 0, countSingle = 0;
// for(let user of users){
...
// 	}
// }
// console.log('Những người đã kết hôn: ' ,countMarried);
// console.log('Những người chưa kết hôn: ',countSingle);

//cách 2
//     let marriedCount = users.filter(function(user){
// 		return user.is_married === true;
// 	})
//     let unmarriedCount = users.filter(user => user.is_married === false);

// console.log('Những người đã kết hôn: ' ,marriedCount);
// console.log('Những người chưa kết hôn là: ' ,unmarriedCount);
